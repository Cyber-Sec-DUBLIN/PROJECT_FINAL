...
public class Player2Attack : MonoBehaviour
{
    ...
    public Vector3 facingPOS = new Vector3(2,0,0);
...
if (player2.transform.position.x > player1.transform.position.x) {
 ...
 if (Input.GetKeyDown(KeyCode.I))  { 
            if (canmove == 1 && player2.transform.position.x < player1.transform.position.x) {
            canmove = 0; 
        ...
        canmove = 1; 
                 ...
                 else if (canmove == 1 && player2.transform.position.x > player1.transform.position.x ) {
            canmove = 0; 
